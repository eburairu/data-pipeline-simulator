...
- [ ] T001 `src/lib/context/` ディレクトリを作成
- [ ] T002 `src/lib/constants.ts` ファイルを作成（空の状態）
...
- [ ] T030 [P] [US3] シミュレーション関連ファイルのマジックナンバーを定数参照に置換
- [ ] T031 [P] [US3] UI関連ファイルのマジックナンバーを定数参照に置換
- [ ] T032 [P] [US3] ストレージ関連ファイルのマジックナンバーを定数参照に置換
